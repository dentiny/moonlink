...
impl MooncakeTable {
    ...
    async fn persist_iceberg_snapshot_impl(
        ...
        println!("iceberg snapshot has completed, remote data files = {:?}", iceberg_persistence_res.remote_data_files);
    ...
    pub(crate) async fn create_mooncake_and_iceberg_snapshot_for_index_merge_for_test(
        ...
        println!("in the merged file indice, files = {:?}", merged.files);
