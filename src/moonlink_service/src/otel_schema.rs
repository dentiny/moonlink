...
fn any_value_struct(ids: &mut i32) -> DataType {
    DataType::Struct(Fields::from(vec![
        ...
        field_with_id("double_value", DataType::Float64, /*nullable=*/true, ids),
        field_with_id("bool_value", DataType::Boolean, /*nullable=*/true, ids),
        field_with_id("bytes_value", DataType::Binary, /*nullable=*/true, ids),
    ]))
}
...
fn exemplar_struct(ids: &mut i32) -> DataType {
    DataType::Struct(Fields::from(vec![
        field_with_id("time_unix_nano", DataType::Int64, /*nullable=*/false, ids),
        field_with_id("as_int", DataType::Int64, /*nullable=*/true, ids),
        field_with_id("as_double", DataType::Float64, true, ids),
        field_with_id("trace_id", DataType::FixedSizeBinary(16), /*nullable=*/true, ids),
        field_with_id("span_id", DataType::FixedSizeBinary(8), /*nullable=*/true, ids),
...
fn common_metric_fields(ids: &mut i32) -> Vec<Field> {
    vec![
        ...
        field_with_id("resource_schema_url", DataType::Utf8, /*nullable=*/true, ids),

        // 5 scope_name
        field_with_id("scope_name", DataType::Utf8, /*nullable=*/true, ids),

        // 6 scope_version
        field_with_id("scope_version", DataType::Utf8, /*nullable=*/true, ids),

        // 7 scope_attributes
        attributes_field("scope_attributes", ids),

        // 8 scope_dropped_attributes_count
        field_with_id("scope_dropped_attributes_count", DataType::Int64, /*nullable=*/true, ids),

        // 9 scope_schema_url
        field_with_id("scope_schema_url", DataType::Utf8, /*nullable=*/true, ids),

        // 10 metric_name
        field_with_id("metric_name", DataType::Utf8, /*nullable=*/false, ids),

        // 11 metric_description
        field_with_id("metric_description", DataType::Utf8, /*nullable=*/true, ids),

        // 12 metric_unit
        field_with_id("metric_unit", DataType::Utf8, /*nullable=*/true, ids),

        // 13 start_time_unix_nano
        field_with_id("start_time_unix_nano", DataType::Int64, /*nullable=*/true, ids),
        ...
        field_with_id("point_dropped_attributes_count", DataType::Int64, /*nullable=*/true, ids),
    ]
}
...
fn number_point_fields(ids: &mut i32) -> Vec<Field> {
    vec![
        ...
        field_with_id("number_double", DataType::Float64, /*nullable=*/true, ids),

        field_with_id("temporality", DataType::Int32, /*nullable=*/true, ids),
        field_with_id("is_monotonic", DataType::Boolean, /*nullable=*/true, ids),
...
fn histogram_point_fields(ids: &mut i32) -> Vec<Field> {
    vec![
        ...
        field_with_id("hist_temporality", DataType::Int32, /*nullable=*/true, ids),
